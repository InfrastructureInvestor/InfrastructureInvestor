...
(function(){
  ...
  ukmrf:{
    ...
    lede:'A council-contracted <b>materials recovery facility</b>, it takes mixed dry recycling, sorts it into paper, card, plastics, metals and glass, and earns two streams: a <b>contracted gate fee</b> on every tonne and the <b>merchant sale</b> of the recovered commodities.',
    s1:'<p class="body">A <b>materials recovery facility (MRF)</b> is a sorting plant. Councils and collectors deliver <b>mixed dry recycling</b>, and the MRF separates it, a trommel screen, optical sorters, a magnet and an eddy-current separator pull out paper, card, plastics, ferrous and non-ferrous metal and glass, baling each into a saleable commodity. In the UK these plants are run by operators such as <b>Viridor</b> and <b>Biffa</b> under long contracts with local authorities.</p>'+
       '<p class="body">The economics are a <b>processor with two revenue streams</b>. First, a <b>gate fee</b>, a charge per tonne accepted, usually contracted with the council, and the stable core of the business. Second, the <b>sale of the recovered commodities</b>, merchant, and priced off volatile global markets for paper, plastic and metal. The gate fee is effectively the margin; the commodity revenue largely offsets the cost of sorting. The thin margin and the commodity-price exposure are what make it an investment with a call option attached.</p>',
    ...
    s3:'A UK MRF sells a <b>service and a set of commodities</b>. It charges a <b>gate fee</b> per tonne, contracted with the council, indexed, and the stable core, and it sells the <b>recovered materials</b> into volatile global markets. The gate fee is effectively the margin; commodity revenue largely offsets the sorting cost. The risks are <b>contamination and residue</b> (material that can\'t be recovered and must be disposed of) and <b>commodity prices</b>. The investment is a gate fee with a commodity-price call.',
  ...
  usmrf:{
    ...
    wfNote:'Operating cost is high-speed sorting (labour, power, maintenance), residue disposal and transport. The gate fee is the margin; commodity sales offset the cost. Single-stream contamination lifts residue; the margin is thin and commodity-sensitive.',
    ...
    breakers:['<b>The gate fee</b>, rebuilt post-Sword to carry the margin and the contracted floor.','<b>Commodity prices</b>, merchant paper, plastic and metal are the swing and the risk.','<b>Contamination &amp; residue</b>, single-stream input lifts residue and erodes recovery.','<b>Offtake &amp; automation</b>, domestic markets and robotics drive value and cost.'],
  ...
  brmrf:{
    ...
    breakers:['<b>The gate fee</b>, the contracted margin and the stable core of a thin-margin business.','<b>Commodity prices</b>, aluminium and metal are the strongest part of the call.','<b>Country &amp; currency</b>, local rates and the currency set the discount rate.','<b>Formalisation &amp; EPR</b>, integrating cooperatives and producer rules drives growth.'],
  ...
  aumrf:{
    ...
    mb:{tag:'Model A · processor with a commodity call', title:'Council-contracted MRF (onshoring)', body:'A modern sorting plant that earns a contracted gate fee (the margin) and sells recovered commodities to domestic reprocessors (the swing), built to onshore sorting after China stopped taking Australia\'s recyclables. The gate fee holds the downside; onshoring steadies offtake. <b>This is an Australian MRF</b> (Cleanaway / Visy-style).'},
    ...
    wfNote:'Operating cost is sorting (labour, power), residue disposal and transport to domestic reprocessors. The gate fee is the margin; commodity sales offset the cost. Onshoring steadies offtake; the margin is thin and commodity-sensitive.',
    ...
    breakers:['<b>The gate fee</b>, contracted with the council, it is the margin and the contracted floor.','<b>Commodity prices</b>, merchant paper, plastic and metal are the swing and the risk.','<b>Onshoring &amp; offtake</b>, domestic reprocessing capacity steadies the commodity revenue.','<b>Contamination &amp; residue</b>, kerbside contamination lifts disposal cost.'],
  ...
  beeah:{
    ...
    wfNote:'Operating cost is sorting at scale (power, maintenance, modest labour), residue disposal and transport. The gate fee is the margin; commodity sales offset the cost. Automation lowers labour; the margin is thin but the absolute base is large.',
    ...
    calcNote:'A working model of a <b>flagship integrated MRF</b>. Revenue is tonnes × (gate fee + commodity value × recovery); the contracted gate fee sets a floor. Scale and automation give operating leverage; the gate fee is the margin and the commodity price is the call.',
    s6:'Bee\'ah is a flagship-scale gate fee with a commodity call. What drives it:',
    breakers:['<b>The gate fee</b>, contracted with the emirate, the margin and the contracted floor.','<b>Commodity prices</b>, merchant paper, plastic and metal are the swing.','<b>Scale &amp; automation</b>, a large, low-labour line gives operating leverage and recovery.','<b>Diversion mandate</b>, the near-zero-landfill target underpins durable throughput.'],
  ...
  cnmrf:{
    ...
    s1:'<p class="body">In 2018 China\'s <b>National Sword</b> banned most imported scrap, the policy that upended recycling worldwide. The flip side is a vast <b>domestic build-out</b>: with imports gone, China is building modern sorting and reprocessing capacity to recover its own waste, supported by a national push on the <b>circular economy</b> and sorting at source in major cities.</p>'+
       '<p class="body">The model is the dual-revenue processor at enormous scale: a <b>gate fee</b> per tonne (often municipal / policy-driven) plus the <b>sale of recovered commodities</b> into a huge domestic manufacturing market that needs the feedstock. The defining feature is <b>scale</b>, a modest gate fee and a thin margin, applied to a colossal tonnage, is a vast cash flow, financed at a low cost of capital and driven by policy as much as by commodity markets.</p>',
    ...
    finNote:'A Chinese recycling plant is a <b>vast-scale dual-revenue processor</b>: a thin gate-fee margin plus a commodity call, on a colossal tonnage, financed at a low cost of capital. The return is steady and large in absolute terms; scale and policy, not price, are the agenda.',
    ...
    breakers:['<b>Scale</b>, a thin margin on a colossal tonnage is the model.','<b>The gate fee</b>, often policy-driven, it is the margin and the contracted floor.','<b>Commodity prices &amp; home demand</b>, a vast manufacturing base absorbs the bales.','<b>Cost of capital &amp; policy</b>, low policy-backed funding and the circular-economy push.'],
