...
(function () {
  ...
  var KEYWORDS = {
    ...
    'infrastructure-private-equity.html': 'fund gp deal team investment committee ic memo paper screening funnel underwrite value creation playbook origination triage 100-day',
  ...
  var TRACKS = [
    ...
    { k: 'deals', no: '02', n: 'Transactions', c: '#b07d24', time: '~1 hr',
      ...
      steps: [
        ...
        ['infrastructure-private-equity.html', 'The investor’s seat', 'The firm behind the bid: the funnel, the screen, the IC paper and the value-creation plan.'],
    ...
    { k: 'allocation', no: '04', n: 'Allocation', c: '#bc4733', time: '~45 min',
      ...
      steps: [
        ...
        ['infrastructure-private-equity.html', 'Inside your GP', 'The funnel, the IC and the value-creation plan your manager runs on your behalf.'],
  ...
  (function () {
    ...
    var cols = [
      ...
      { h: 'M&A & deals', links: [
        ...
        ['Infrastructure private equity', 'infrastructure-private-equity.html'],
  ...
  if (wrap) {
    ...
    var maItems = [
      ...
      { t: 'Infrastructure private equity', u: 'infrastructure-private-equity.html' },
