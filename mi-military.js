...
(function(){
  ...
  allenby:{
    ...
    s4a:'A defence-accommodation PFI carries a real cost: <b>facilities management</b> — cleaning, grounds, security, response — and <b>lifecycle and estate maintenance</b> — replacing roofs, plant and fabric across the estate over the concession. These are sized into the charge, so the margin is moderate, not enormous. The defining number is not the cost line but the <b>contracted, indexed availability charge and the availability</b> behind it.',
  ...
  mhpi:{
    ...
    s1:'<p class="body">The <b>Military Housing Privatization Initiative (MHPI)</b> transferred most US on-base family housing to private partners — names such as Balfour Beatty Communities, Lincoln Military Housing and Hunt — under <b>~50-year ground leases</b>. The partner <b>finances, builds, renovates and operates</b> the housing, and is repaid through <b>rents</b> that are funded by each servicemember\'s <b>Basic Allowance for Housing (BAH)</b> — a government housing allowance that effectively underpins the cash flow.</p>'+
       '<p class="body">It is an availability-style housing annuity at <b>enormous scale</b> and <b>extraordinary length</b>. The demand is structurally underpinned — service families occupy the housing and their BAH flows to the partner — so the model behaves like a contracted, government-backed annuity with very limited true demand risk. The defining features are the <b>50-year term</b>, the <b>BAH-backed</b> revenue and the <b>covenant strength</b> of the Department of Defense behind it. New phases and renovations extend the estate. (Figures here are illustrative.)</p>',
    ...
    s2:'Watch the estate — rows of on-base family housing, blocks lit, the flag flying. The <b style="color:#0c6b4f">Department of Defense</b> underpins the rent through each family\'s <b>Basic Allowance for Housing</b>. The partner\'s money is the <b>charge on every home kept available and occupied</b>, indexed, underpinned by BAH — not speculative market demand. The cost draining out is <b>property management, maintenance and lifecycle</b>. Drag the homes, the charge and the availability — a vast, very long, government-underpinned housing annuity.',
  ...
  latam:{
    ...
    lede:'An emerging <b>defence-estate PPP</b> — a private concessionaire builds and maintains serviceperson accommodation and supporting estate, and the defence ministry pays a contracted, indexed availability charge, with no demand risk but emerging-market rates. (Illustrative.)',
    ...
    s2:'Watch the estate — new accommodation blocks behind a gated, maintained perimeter, the flag flying, the parade square. The <b style="color:#0c6b4f">defence ministry</b> pays the <b>availability charge</b> for keeping it available and the facilities delivered. The concessionaire\'s money is the <b>charge on every unit kept available</b>, indexed, not how the estate is used. Drag the units, the charge and the availability — a contracted annuity at an emerging-market discount rate.',
    driverLab:'Charge / unit', availLab:'Availability', hrK:'Availability charge', yrS:'units × charge × availability',
    ledge:{a:'+ availability',b:'+ indexation',c:'− FM & estate'}, demandLabel:'AVAILABILITY',
    preset:'Load LatAm estate PPP',
    try:'<b>Try this:</b> raise the <b>availability</b> and watch the charge hold flat at the contracted level — a defence-estate concession pays for keeping the accommodation <b>available</b>, not for how it is used, so above the threshold the revenue is contracted. Then push the cost of debt: a strong contracted number nets down once discounted like an emerging-market concession. The contract is solid; the debate is the discount rate.',
    s3:'The concessionaire earns a <b>contracted availability charge</b> for keeping the accommodation available and delivering the supporting facilities, indexed to inflation, with <b>deductions</b> for failures. There is <b>no demand risk</b> — how the estate is used is the state\'s. So the income is a fully contracted government annuity, set by the units, the charge and availability. The investor question is less the contract than the <b>discount rate</b> — sovereign risk and the dollar-local mix.',
    mb:{tag:'Model B · defence estate PPP', title:'Emerging-market availability estate', body:'A concession in which a private party builds, finances and maintains defence accommodation and supporting estate, paid a contracted, indexed availability charge by the defence ministry — no demand risk, deductions for failures. A fully contracted annuity priced against emerging-market rates. <b>This is an illustrative Latin-American defence-estate PPP</b>.'},
    s4a:'The concessionaire carries <b>full facilities management and lifecycle</b> — accommodation upkeep, supporting facilities and estate renewal — sized into the availability charge. Margins are healthy because the charge is set to cover it, but the swing factor is not the cost line — it is the <b>contracted charge and the discount rate</b> on an emerging-market concession.',
    wfNote:'Operating cost is the facilities management plus the lifecycle renewal of accommodation and estate — real, because deductions penalise failures. The charge is set to cover it at a contracted margin; the value driver is the indexed charge and the emerging-market discount rate.',
    ...
    finNote:'A defence-estate concession is a <b>fully contracted government annuity</b>: an indexed charge for keeping the accommodation available, with no demand risk. The whole investment debate is the <b>discount rate</b> — sovereign risk and the dollar-local mix — more than the contract.',
    ...
    s6:'A defence-estate concession is a contracted annuity at an EM discount rate. What drives it:',
    breakers:['<b>Availability</b> — the charge is for keeping the accommodation available; deductions bite for failures.','<b>Contracted charge</b> — the indexed charge, not how the estate is used, sets the revenue.','<b>Country &amp; currency</b> — sovereign risk and the dollar-local mix set the discount rate.','<b>FM &amp; estate</b> — delivering the facilities and lifecycle is the operational risk.'],
  ...
  dha:{
    ...
    s1:'<p class="body">Australia houses service families through a long-running defence-<b>housing model</b> in which homes are <b>built, owned and leased</b> to provide serviceperson accommodation, and the <b>Department of Defence</b> underpins the rent. Investors participate through <b>lease-back</b> and accommodation-PPP structures: a private party finances and maintains the housing, and Defence pays a contracted, inflation-indexed <b>availability-style rent</b> for keeping it available and maintained over a long term.</p>'+
       '<p class="body">Backed by an <b>investment-grade</b> sovereign and denominated in Australian dollars, the accommodation core is a clean social-infrastructure cash flow. The party takes <b>no demand risk</b> on the availability core — how Defence allocates the housing is its own — and is paid for <b>availability and maintenance</b>, with adjustments for unavailable or sub-standard homes. It is a long, government-backed, indexed, demand-risk-free housing annuity — the kind of asset that anchors a core portfolio.</p>',
    ...
    s2:'Watch the estate — rows of defence housing behind a gated, maintained estate, the flag flying. <b style="color:#0c6b4f">The Department of Defence</b> underpins the <b>availability rent</b> for keeping the housing available and maintained. The party\'s money is the <b>rent on every home kept available</b>, indexed — how the housing is allocated sits with Defence. Drag the homes, the charge and the availability — a core, government-backed housing annuity.',
    driverLab:'Rent / home', availLab:'Availability', hrK:'Availability rent', yrS:'homes × rent × availability',
    ledge:{a:'+ availability',b:'+ indexation',c:'− FM & estate'}, demandLabel:'AVAILABILITY',
    preset:'Load defence housing',
    try:'<b>Try this:</b> raise the <b>availability</b> and watch the rent sit flat at the contracted level — Defence underpins the payment for keeping the housing <b>available and maintained</b>, not for how it is allocated. With an investment-grade sovereign the discount rate is low and gearing high. Drop availability and adjustments bite — a clean, contracted social-infrastructure cash flow.',
    ...
    s4a:'The party carries <b>full property maintenance and lifecycle</b> over the term — repairs, grounds and renewal of the housing stock — sized so the availability rent covers it at a contracted margin. With an investment-grade sovereign the margin is steady. The defining feature is not the cost line but the <b>contracted, indexed rent</b> and the low discount rate a sovereign counterparty permits.',
    ...
    calcNote:'A working model of an <b>Australian defence-housing model</b>, on an enterprise-value basis. Revenue is the contracted, indexed availability rent; the floor binds when availability is high, so revenue is flat. A low cost of debt and high gearing reflect an investment-grade sovereign.',
    s6:'Defence housing is a core, government-backed housing annuity. What drives it:',
  ...
  gulf:{
    ...
    lede:'An emerging Gulf <b>defence-estate PPP</b> — a private consortium builds and maintains serviceperson accommodation and estate, and the defence ministry pays a contracted, often hard-currency-linked availability charge under sovereign backing, with FX and treasury considerations. (Illustrative.)',
    s1:'<p class="body">Gulf states have begun applying their growing <b>PPP</b> frameworks to the defence estate: a private consortium <b>designs, builds, finances and maintains</b> serviceperson living accommodation, messes and supporting facilities, while the <b>Ministry of Defence</b> keeps the operational mission and pays a contracted <b>availability charge</b> over a long concession, typically with <b>sovereign backing</b>.</p>'+
       '<p class="body">It is the defence-accommodation availability PPP with an <b>emerging-market, hard-currency</b> twist. The consortium takes <b>no demand risk</b> — how the estate is used is the state\'s — and earns a contracted, indexed <b>availability payment</b> for keeping the accommodation available and the facilities delivered, with <b>deductions</b> for failures. The defining considerations are <b>FX and sovereign credit</b>: the payments are often hard-currency-linked and underpinned by a strong sovereign, so the credit and currency story drives the discount rate. A new phase extends the estate. (Names and figures here are illustrative.)</p>',
    ...
    s2:'Watch the estate — new accommodation blocks behind a gated, maintained perimeter, the flag flying, a parade square. The <b style="color:#0c6b4f">defence ministry</b> pays the <b>availability charge</b> for keeping it available and the facilities delivered, under sovereign backing. The consortium\'s money is the <b>charge on every unit kept available</b>, indexed. Drag the units, the charge and the availability — a contracted annuity with FX / sovereign considerations.',
    driverLab:'Charge / unit', availLab:'Availability', hrK:'Availability charge', yrS:'units × charge × availability',
    ledge:{a:'+ availability',b:'+ indexation',c:'− FM & estate'}, demandLabel:'AVAILABILITY',
    preset:'Load Gulf estate PPP',
    try:'<b>Try this:</b> raise the <b>availability</b> and the charge holds at the contracted level — the ministry pays for keeping the accommodation <b>available</b>, not for how it is used. The credit and currency story (sovereign backing, hard-currency linkage) sets the discount rate: a contracted annuity priced against a strong but emerging-market sovereign. Push the cost of debt to see the FX / sovereign premium net the value down.',
    s3:'The consortium earns a <b>contracted availability payment</b> for keeping the accommodation available and delivering the facilities, indexed and often <b>hard-currency-linked</b>, with <b>deductions</b> for failures, and takes <b>no demand risk</b> — how the estate is used is the state\'s. The payment is underpinned by a <b>strong sovereign</b>. The income is a fully contracted government annuity; the investor question is the <b>FX and sovereign credit</b> that set the discount rate.',
    mb:{tag:'Model B · Gulf estate PPP', title:'Sovereign-backed availability estate', body:'A defence-estate PPP in which a consortium builds, finances and maintains accommodation and facilities, paid a contracted, indexed, often FX-linked availability charge by the defence ministry under sovereign backing — no demand risk, deductions for failures. A contracted annuity with FX / sovereign considerations. <b>This is an illustrative Gulf defence-estate PPP</b>.'},
    s4a:'The consortium carries <b>full facilities management and lifecycle</b> across the estate — accommodation upkeep, supporting facilities and renewal — sized into the availability charge. The margin is healthy, but the swing factor is not the cost line — it is the <b>contracted charge, the FX linkage and the sovereign credit</b> behind the backing.',
    wfNote:'Operating cost is the facilities management plus the lifecycle renewal of accommodation and estate — real, because deductions penalise failures. The charge is set to cover it; the value driver is the indexed, often FX-linked payment and the sovereign credit behind the backing.',
    ...
    finNote:'A Gulf defence-estate PPP is a <b>sovereign-backed contracted annuity</b>: an indexed, often FX-linked availability charge for keeping the accommodation available, no demand risk. The whole investment debate is the <b>FX and sovereign credit</b> behind the backing, more than the contract.',
    ...
    calcNote:'A working model of a <b>Gulf defence-estate PPP</b>, on an enterprise-value basis. Revenue is the contracted, indexed availability charge; the floor binds when availability is high. A higher cost of debt reflects emerging-market sovereign and FX risk, so a strong contracted number nets down once discounted. Figures are highly illustrative.',
    s6:'A Gulf estate PPP is a sovereign-backed contracted annuity. What drives it:',
