...
(function(){
  ...
  nhs:{
    ...
    s4a:'A PFI hospital carries a real cost: <b>facilities management (soft FM)</b> covering cleaning, catering, security and portering, plus <b>lifecycle (hard FM)</b> to replace roofs, plant and fabric over the concession. These are sized into the charge, so the margin is moderate, not enormous. The defining number is not the cost line but the <b>contracted, indexed unitary charge and the availability</b> behind it.',
