...
(function(){
  ...
  ercot:{
    ...
    s3:'ERCOT wind sells into an <b>energy-only merchant market</b>, so revenue is output × a volatile spot price. The capacity factor (a strong plains resource) makes the energy; the <b>price and the hedging</b> make the return. Owners shape the price risk with financial hedges and corporate PPAs, which floor part of the revenue. The return is higher than a fully contracted asset but carries genuine <b>price risk</b> — the defining feature of merchant wind.',
    mb:{tag:'Model A · merchant vs contracted', title:'Texas merchant wind (ERCOT)', body:'Vast plains wind selling into the energy-only ERCOT market, where output is large but the spot price swings — revenue shaped with hedges and corporate PPAs that floor part of the price. Higher expected return than contracted wind, but real price risk. <b>This is ERCOT wind</b>.'},
    ...
    breakers:['<b>Capacity factor</b> — the plains wind resource sets the volume of output.','<b>The power price</b> — a volatile, energy-only merchant market is the swing factor.','<b>Hedges &amp; PPAs</b> — they floor part of the price and shape the risk.','<b>Merchant vs contracted</b> — the split sets both the expected return and the risk.'],
  ...
  casadosventos:{
    ...
    mb:{tag:'Model A · merchant vs contracted', title:'Brazilian onshore wind (PPA + merchant, EM)', body:'World-class northeast trade-wind sites with very high capacity factors, sold on long PPAs (a revenue floor) plus merchant — an excellent physical asset, but carried at an emerging-market discount rate. <b>This is Casa dos Ventos</b> — partnered with TotalEnergies.'},
    s4a:'The operating cost is <b>tiny</b> — no fuel, just O&amp;M per MW — so the margin is very high and the waterfall drops only a sliver to costs. The exceptional capacity factor makes the volume large; the question for value is the <b>price</b> (PPA-floored plus merchant) and, above all, the <b>discount rate</b> at which a Brazilian cash flow is carried.',
    wfNote:'No fuel — only O&amp;M per MW — so the margin is very high. The output is exceptional (world-class capacity factor); revenue is output × price, floored by PPAs, then discounted at an emerging-market rate.',
    ...
    finNote:'Casa dos Ventos is a <b>world-class physical asset at an emerging-market discount rate</b>: a very high capacity factor and high margin, floored by PPAs, but carried at a high local cost of capital. The debate is the discount rate and the offtake, not the wind resource.',
  ...
  goldenplains:{
    ...
    s4a:'The operating cost is <b>tiny</b> — no fuel, just O&amp;M per MW — so the margin is very high. The value sits in the capacity factor (the volume) and the <b>price</b>: a state-support floor on part of the output plus a merchant tail, in a high-but-volatile NEM where firming increasingly matters.',
    wfNote:'No fuel — only O&amp;M per MW — so the margin is very high. Revenue is output × price, with a state CfD-style floor on the contracted portion and a merchant tail in the volatile NEM.',
