...
(function(){
  ...
  iwnl:{
    ...
    s1:'<p class="body">When a developer builds a new estate, the water mains, sewers and connections can be provided not by the regional monopoly but by a <b>New Appointment &amp; Variation (NAV)</b>, a licensed water company appointed for that specific site. It builds and adopts the network and becomes the water and wastewater provider for every plot.</p>'+
       '<p class="body"><b>Independent Water Networks (IWNL)</b> is one of Britain\'s largest NAVs. The economics mirror an electricity IDNO: the <b>developer largely funds the build</b>, so the operator\'s net capital per plot is small, and in return it earns a regulated <b>per-connection charge</b>, capped at the incumbent\'s level by Ofwat\'s relative price rules and indexed, for the life of the development. The engine is the <b>count of connections and how fast they fill</b>, not how much water flows.</p>',
    ...
    s4a:'A NAV is light on operating cost beyond the <b>wholesale water and sewerage</b> it buys from the incumbent and a small metering, billing and O&amp;M overhead, so the margin on the regulated charge is steady. The defining number is not opex but the <b>connections pipeline</b>: how many plots are contracted, built and connected, because each one adds an indexed annuity at very little net capital.',
    wfNote:'Operating cost is the wholesale water and sewerage bought from the incumbent, plus metering, billing and a small O&amp;M overhead. The value is in the connections count and the pace of occupancy, not the cost line.',
  ...
  gwr:{
    ...
    lede:'A pure-play <b>growth-by-connections</b> water utility in one of America\'s fastest-growing regions, it earns its return by connecting new homes across the Phoenix metro.',
    ...
    s4a:'A small utility carries real per-connection opex, water treatment, recycling, pumping and customer service, but the regulated charge and the growth tailwind keep the margin healthy and rising with scale. The defining feature is the <b>connections growth</b>, not the cost line.',
  ...
  aegea:{
    ...
    s4a:'Operating cost is treatment, pumping, network O&amp;M and a large field operation across a growing footprint, real, but set against a regulated tariff that grows with every connection, the margin builds with scale. The defining lever is the connections programme, not the cost line in any one year.',
    ...
    finNote:'A Brazilian sanitation concession is a <b>mass-connection growth story</b> on a regulated, indexed cash flow: connect households, grow the tariff base. The whole investment debate is the <b>discount rate</b>, Brazilian rates and the real, more than the asset.',
