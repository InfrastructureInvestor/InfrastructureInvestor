...
(function(){
  ...
  ukbio:{
    ...
    breakers:['<b>The green incentive</b> — GGSS/RHI does most of the work in the price; its durability is the whole thesis.','<b>Feedstock cost &amp; supply</b> — the principal cost and the binding constraint on the plant.','<b>Load factor</b> — AD wants to run flat-out baseload; idle digesters still cost feedstock and O&amp;M.','<b>Gate fee &amp; digestate</b> — taking waste and selling fertiliser add to a thin energy margin.'],
  ...
  usrng:{
    ...
    finNote:'US RNG is the <b>purest incentive asset</b> here: the gas is a rounding error and stacked credits are the price. Returns can be exceptional, but the credit markets are volatile and policy-set — that is the whole risk, alongside feedstock logistics.',
    ...
    calcNote:'A working model of a <b>dairy / landfill RNG project</b>, in US$. Revenue is RNG produced × a credit-rich price (gas + LCFS + RIN + 45Z); the margin is what is left after feedstock logistics and parasitic load. The floor models contracted / fixed-price credit sales.',
    s6:'US RNG is credit-led decarbonised gas — high return, high credit risk. What drives it:',
    breakers:['<b>The credit stack</b> — LCFS, RINs and 45Z are almost the entire price; their level and durability are everything.','<b>Credit-price volatility</b> — the markets swing hard, so part of the stack is sold forward.','<b>Feedstock logistics</b> — manure is cheap but aggregating and digesting it is not.','<b>Methane abatement</b> — capturing dairy/landfill methane is the underlying environmental driver.'],
  ...
  brbio:{
    ...
    lede:'Brazil\'s vast sugar-and-ethanol sector throws off <b>vinasse and bagasse</b> — and a wave of <b>agri-biogas</b> plants now digest that residue into biomethane, turning an effluent into decarbonised gas.',
    s1:'<p class="body">Brazil produces enormous volumes of agricultural residue — <b>vinasse</b> (the liquid effluent from ethanol distillation), filter cake and bagasse from sugarcane, plus livestock and crop waste. Left alone these are a disposal problem; digested in <b>anaerobic digesters</b> they become <b>biogas</b>, upgraded to biomethane for the grid or burned in a CHP engine, with the digestate returned to the cane fields as fertiliser.</p>'+
    ...
    s4a:'The dominant cost is still <b>feedstock and parasitic load</b>, but the feedstock is a cheap on-site residue, so the cost base is light and the margin healthy. Plant O&amp;M is modest. The structural feature is the incentive regime (RenovaBio) and the avoided cost of effluent disposal, carried in reais.',
    wfNote:'Operating cost is feedstock handling, parasitic power and O&amp;M — light, because the feedstock is an on-site residue. The margin is biomethane plus RenovaBio incentive plus an embedded gate value, less a low feedstock cost.',
    s4b:'The capital is the <b>digesters</b>, the <b>upgrading skid</b> (or CHP engine) and the interconnect, sited at the mill. Modelled on an enterprise-value basis, the return is carried at <b>local rates and currency</b> — a developing but fast-growing market where the discount rate and the incentive regime do most of the work.',
    ...
    finNote:'A Brazilian agri-biogas plant is a <b>cheap-feedstock production asset at an EM discount rate</b>: a healthy margin on an on-site residue, supported by RenovaBio. The whole investment debate is the <b>discount rate</b>, the currency and the pace of market and incentive development.',
    timeline:[['2017','<b>RenovaBio</b> launched — Brazil\'s biofuels decarbonisation policy.'],['2010s','<b>Vinasse biogas</b> pilots at sugar-ethanol mills.'],['2020s','<b>Biomethane offtake</b> and CBIO credits scale the model.'],['2020s','<b>Agri-biogas wave</b> across the cane belt.'],['Periodic','<b>CBIO prices</b> reset the incentive value.'],['Long-term','<b>Market growth</b> as residue valorisation spreads.']],
